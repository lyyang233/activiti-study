...
public class BXLCTest {
    ...
    private void myDeploy() {
        //部署bpmn文件
        String bpmnClasspath = "bpmn/flow4.bpmn";
        // 创建部署构建器
        ...
        List<ProcessDefinition> myProcess = processDefinitionQuery.processDefinitionKey("bxlc").list();
...
//        assertEquals(1, count);
    ...
    private void userTaskManagement() {
        ...
        // 启动流程
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("bxlc");
